...
public class TwitterQueryUserJwtConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    // Pegando as Roles definidas no client do keycloak no console admin do keycloak
    ...
    // Pegando os Scopes definidos no client do keycloak no console admin do keycloak
