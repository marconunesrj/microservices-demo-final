...
public class QueryController {
    ...
    public String queryByText(@Valid ElasticQueryWebClientRequestModel requestModel, Model model) {
        ...
        // Para utilizar o thymeleaf utilizamos a interface IReactiveDataDriverContextVariable para
        // envolver a resposta Flux nesta classe reativa.
        // O segundo parâmetro com valor 1 é para definir o buffer como 1, para ver os resultados 1 por 1 no navegador.
        IReactiveDataDriverContextVariable reactiveData =
                new ReactiveDataDriverContextVariable(responseModel, 1);
        // Enviando para o modelo Thymeleaf
