...
// Ver documentação do Spring boot kafka
@Configuration
public class KafkaProducerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    // Pega os valores no application.yml
    @Bean
...
//    public KafkaTemplate<K, V> kafkaTemplate() {
//        final KafkaTemplate<K, V> kvKafkaTemplate = new KafkaTemplate<>(this::producerFactory);
//        return kvKafkaTemplate;
//    }
}
