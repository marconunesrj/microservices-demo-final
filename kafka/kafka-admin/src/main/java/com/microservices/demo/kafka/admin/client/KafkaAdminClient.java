...
public class KafkaAdminClient {
    ...
    private final RetryConfigData retryConfigData;  // Estas propriedades vem do arquivo application.yml

    private final AdminClient adminClient;  // É um @Bean da classe KafkaAdminConfig

    private final RetryTemplate retryTemplate;

    private final WebClient webClient;  // É um @Bean da classe WebClientConfig (webflux no pom.xml)
