...
public class WebClientConfig {
    ...
    @LoadBalanced  // Funciona com Builder
    @Bean("webClientBuilder")  // Utilizando uma anotação com qualificador "webClientBuilder",
                               // utilizado na classe TwitterElasticQueryWebClient
