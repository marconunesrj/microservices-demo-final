...
public class ElasticDocumentController {
    ...
    @PostMapping(value = "/get-doc-by-text",
            produces = MediaType.TEXT_EVENT_STREAM_VALUE,  // Retornar a resposta por partes para o cliente
    ...
    public Flux<ElasticQueryServiceResponseModel> getDocumentByText(
        ...
        // log -> observa todos os sinais de fluxo reativos e os rastreia usando suporte do registrador
