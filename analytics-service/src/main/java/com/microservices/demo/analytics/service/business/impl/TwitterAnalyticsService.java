...
public class TwitterAnalyticsService implements AnalyticsService {
    ...
    public Optional<AnalyticsResponseModel> getWordAnalytics(String word) {
        // PageRequest.of(0, 1) -> para obter o primeiro registro, que será a última contagem de palavras para uma palavra,
        // conforme consultamos usando ordem por data de criação.
