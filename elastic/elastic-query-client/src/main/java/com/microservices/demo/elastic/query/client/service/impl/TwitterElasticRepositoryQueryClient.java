...
// @Primary -> Indica que esta classe tem prioridade na utilização pelo Spring Boot.
// pode-se utilizar a outra forma com a anotação @ConditionalOnProperty.
// Ver classe TwitterElasticIndexClient no módulo: elastic-index-client
@Primary
@Service
